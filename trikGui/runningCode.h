...
public:
	...
	/// @param controller - reference to object providing access to
	/// low-level functionality.
	/// @param parent - parent of a widget in terms of Qt parent-child
	/// widget relations.
	explicit RunningCode(Controller &controller, QObject *parent = 0);

	/// Associates running widget with a new script.
	void setProgram(const QString &programName, int scriptId);

	/// Returns an id of the script which information running widget is
