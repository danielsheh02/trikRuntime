...
/// Widget that allows selection of TrikGUI interface language. Uses
/// "translations" folder and "locale.ini" files there to find available
/// languages. Stores selected language in localSettings.ini.
