...
public:
	enum class SensorType { Sensors, Encoder, Gyroscope, Accelerometer, Camera, PwmCapture };

	explicit Sensors(trikControl::BrickInterface &brick, const QStringList &ports, SensorType sensorType,
			 QObject *parent = 0);
