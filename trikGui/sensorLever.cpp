...
// 	: QWidget(parent), mIsGreater(true), mMaxDistance(100), mMinDistance(0),
// 	  mDistanceStep(5), mDistance(0), mNameLabel(port),
// 	  mSignLabel(QString(">")) {
...
// 	// mSignLabel can change its width during work. It will cause
// 	// mDistanceBar width change. To prevent it, we set fixed width it.
// 	mSignLabel.setFixedWidth(
// 	    AbstractIndicator::fontMetricsHorizontalAdvance(this, "WWWW"));
...
// 	mIsGreater ? mSignLabel.setText(QString(">"))
// 		   : mSignLabel.setText(QString("<"));
// }

// int SensorLever::distance() const { return mDistance; }

// bool SensorLever::isGreater() const { return mIsGreater; }
